...
app.post('/register', async (request, response) => {
  ...
  const dbUser = await db.get(userName)
  if (dbUser === undefined) {
    const insertQuery = `INSERT INTO user(username, name, password, gender, location) VALUES ('${username}','${name}','${hashedPassword}','${gender}','${location}');`
